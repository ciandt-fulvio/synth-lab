...
description: Analisa commits e sugere testes necessários (unit, integration, contract, smoke, E2E). Roda em background após commits.
...
```bash
# 1. Criar migration
DATABASE_URL="$DATABASE_TEST_URL" alembic revision --autogenerate -m "Add {Model}"
