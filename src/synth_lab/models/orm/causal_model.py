...
from sqlalchemy import ForeignKey, ForeignKeyConstraint, Index, SmallInteger, String, Text
...
class CausalModel(Base, TimestampMixin):
    """
    ...
    nodes: Mapped[list] = mapped_column(JSONVariant, nullable=False)
    raw_llm_response: Mapped[dict | None] = mapped_column(JSONVariant, nullable=True)
...
class CausalEdge(Base):
    ...
    options: Mapped[list] = mapped_column(JSONVariant, nullable=False)
